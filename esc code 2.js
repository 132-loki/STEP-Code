...
// Sort dishes by their state index
...
// logger.info(dishtoMenuDishes);
// Add sorted dishes to their respective tables
dishtoMenuDishes.forEach(function(dishData) {
...
dishRecipeAmendmentDishes.forEach(function(dishData) {
    var new1 = dishData.dish;
    table1 += "<tr>" +
        "<td>" + new1[0] + "</td>" +
        "<td>" + new1[1] + "</td>" +
